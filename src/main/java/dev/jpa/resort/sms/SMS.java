...
public class SMS {
  ...
  public static void main(String[] args) throws IOException {
    ...
    .addFormDataPart("phone", "01065478580") // 수신번호를 입력해 주세요. (수신번호가 두 개 이상인 경우 ',' 를 이용하여 입력합니다. ex) 01011112222,01033334444)
    .addFormDataPart("callback", "01027229751") // 발신번호를 입력해 주세요. (변경하지 말것)
    .addFormDataPart("message", "가비아 3기 숫자 4자리를 인증 번호 입력란에 입력하세요. [1234]") // SMS 내용을 입력해 주세요.
