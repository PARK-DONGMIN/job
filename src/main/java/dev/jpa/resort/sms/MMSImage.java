...
public class MMSImage {
    ...
    public static void main(String[] args) throws IOException, FontFormatException {
        // 텍스트가 없는 GPT가 생성한 원본 이미지 불러오기
        File input = new File("C:\\kd\\deploy\\resort_v5jpac\\mms\\storage\\gpt_mms.jpg");
        ...
        sb.append("일시: 2025년 12월 1일 화요일 10시\n");
        sb.append("장소: 관악산\n");
        ...
        // 결과 저장: 이미지 + Text
        File output = new File("C:\\\\kd\\\\deploy\\\\resort_v5jpac\\\\mms\\\\storage\\\\gpt_mms_output.jpg");
