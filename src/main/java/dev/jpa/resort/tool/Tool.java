...
public class Tool {
  ...
  public static String getServerDir(String dir) {
    ...
    if (osName.contains("win")) { // Windows
      path = "C:\\kd\\deploy\\resort_v5jpac\\" + dir + "\\storage\\";
      // F:\kd8\\deploy\\resort_v1jpac\\home\\storage\\
      // System.out.println("Windows: " + path);
    } else if (osName.contains("mac")) { // MacOS
      path = "/Users/yourusername/deploy/resort_v5jpac/"+dir+"/storage/";
      // System.out.println("MacOS: " + path);
    } else { // Linux
      path = "/home/ubuntu/deploy/resort_v5jpac/" + dir + "/sorage/";
  ...
  public static String getSMSToken() throws IOException {
    ...
    String apiKey = "c014b2f02bb8e3c1f245a72856518778"; // SMS 관리툴에서 발급받은 API KEY 를 입력해 주세요.
    ...
    RequestBody requestBody = new MultipartBody.Builder().setType(MultipartBody.FORM).addFormDataPart("grant_type", "client_credentials").build();
